...
```sudo docker compose up --build``` to spin up the docker containers on your machine. If you have processes running on those ports you can either free those up for the docker containers or change the ports they run on in the docker-compose.yml.
